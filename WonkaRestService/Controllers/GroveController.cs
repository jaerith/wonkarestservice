...
{
    public class GroveController : WonkaBaseController
    {
        /// <summary>
        /// 
        ...
        public HttpResponseMessage GetGrove(string GroveId)
        {
            ...
            catch (Exception ex)
            {
                ...
                Grove.StackTraceMessage = ex.StackTrace;
        ...
        public HttpResponseMessage PostGrove(SvcGrove GroveData)
        {
            ...
            try
            {
                ...
                if (GroveData.SerializeToBlockchain)
                    GroveData.Serialize(moWonkaRegistryInit.BlockchainRegistry, moWonkaRegistryInit.Web3HttpUrl);
            ...
            catch (Exception ex)
            {
                ...
                GroveData.StackTraceMessage = ex.StackTrace;
